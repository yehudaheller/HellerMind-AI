...
HellerMind-AI is a fast, browser-based AI development workspace for building, editing, previewing, and shipping full-stack applications. It supports OpenAI, Anthropic, Ollama, OpenRouter, Gemini, LM Studio, Mistral, xAI, Hugging Face, DeepSeek, Groq, Cohere, Together, Perplexity, Moonshot, Hyperbolic, GitHub Models, Amazon Bedrock, and OpenAI-compatible providers.

This project is based on the open-source [bolt.diy](https://github.com/stackblitz-labs/bolt.diy) platform and retains compatibility with its artifact/action protocol and WebContainer workflow.

---

See the upstream [bolt.diy documentation](https://stackblitz-labs.github.io/bolt.diy/) for additional provider and installation details.
...
Let's get HellerMind-AI running locally.
...
1. **Clone the Repository**:
   ...
   ```bash
   git clone https://github.com/yehudaheller/HellerMind-AI.git
   ```
