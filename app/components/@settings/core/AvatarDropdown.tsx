      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          <DropdownMenu.Item
            ...
            onClick={() => window.open('https://github.com/yehudaheller/HellerMind-AI/issues/new', '_blank')}
          >
          ...
          <DropdownMenu.Item
            ...
            onClick={() => window.open('https://github.com/yehudaheller/HellerMind-AI', '_blank')}
          >
